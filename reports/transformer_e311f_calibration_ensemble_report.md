...
Best raw: `ensemble pre-R7 all selected` = `0.9402`.
Best calibrated/ensemble: `ensemble pre-R7 all selected` = `0.9398`.
...
| R7 tiny denoise seed 1 | 0.9320 | 0.9329 | 0.9277 | 0.9084 | 0.9626 | `[-0.01, -0.24, 0.0]` | `[[719, 51, 5], [55, 704, 16], [9, 20, 746]]` |
| R7 tiny denoise seed 2 | 0.9355 | 0.9346 | 0.9265 | 0.9148 | 0.9626 | `[-0.02, -0.02, 0.0]` | `[[718, 53, 4], [56, 709, 10], [8, 21, 746]]` |
| R7 tiny denoise seed 3 | 0.9351 | 0.9351 | 0.9110 | 0.9252 | 0.9690 | `[0.09, 0.31, 0.0]` | `[[706, 64, 5], [39, 717, 19], [6, 18, 751]]` |
| R7 tiny denoise lambda 5 bad 0.05 | 0.9381 | 0.9359 | 0.9381 | 0.9084 | 0.9613 | `[0.33, -0.35, 0.0]` | `[[727, 45, 3], [65, 704, 6], [11, 19, 745]]` |
| R7 late denoise lambda 8 bad 0.05 | 0.9376 | 0.9376 | 0.9277 | 0.9265 | 0.9587 | `[-0.03, 0.0, 0.0]` | `[[719, 54, 2], [52, 718, 5], [11, 21, 743]]` |
| R7 tiny denoise SNR 0.02 | 0.9359 | 0.9368 | 0.9355 | 0.9148 | 0.9600 | `[-0.13, -0.21, 0.0]` | `[[725, 46, 4], [57, 709, 9], [9, 22, 744]]` |
...
| ensemble pre-R7 all selected | 0.9402 | 0.9398 | 0.9303 | 0.9277 | 0.9613 | `[0.0, 0.11, 0.0]` | `[[721, 51, 3], [49, 719, 7], [8, 22, 745]]` |
| ensemble all selected incl R7 | 0.9389 | 0.9389 | 0.9316 | 0.9265 | 0.9587 | `[0.35, 0.29, 0.0]` | `[[722, 50, 3], [51, 718, 6], [11, 21, 743]]` |
| ensemble R7 seeds | 0.9381 | 0.9372 | 0.9303 | 0.9161 | 0.9652 | `[0.15, -0.07, 0.0]` | `[[721, 51, 3], [51, 710, 14], [9, 18, 748]]` |
| ensemble R7 tiny family | 0.9372 | 0.9376 | 0.9303 | 0.9239 | 0.9587 | `[0.31, 0.16, 0.0]` | `[[721, 51, 3], [51, 716, 8], [11, 21, 743]]` |
