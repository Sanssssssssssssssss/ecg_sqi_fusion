# v79rawcarrier_bad_envelope_ot_fast Subtype-Balanced PTB Synthetic Distribution Report

- Created: `2026-06-23 22:39:11`
- Protocol: `E:\GPTProject2\ecg\outputs\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\protocol_v79rawcarrier_bad_envelope_ot_fast_pc1500_s20260682`
...
- Shared PCA: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_shared_pca_but_vs_ptb.png`
- Feature gap heatmap: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_subtype_feature_gap_heatmap.png`
- PTB waveform sheets: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_ptb_synthetic_good_subtype_waveforms.png`, `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_ptb_synthetic_medium_subtype_waveforms.png`, `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_ptb_synthetic_bad_subtype_waveforms.png`
- BUT waveform sheets: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_but_keepoutlier_good_subtype_waveforms.png`, `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_but_keepoutlier_medium_subtype_waveforms.png`, `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\event_xds_aligned_v79rawcarrier_bad_envelope_ot_fast\v79rawcarrier_bad_envelope_ot_fast_but_keepoutlier_bad_subtype_waveforms.png`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| bad | bad_baseline_wander_lowfreq | 62 | 214 | 1 | 4.40216 | 1.46084 | 0.975369 | 4.33801 | 8.1069 |
| bad | bad_contact_reset_flatline | 188 | 214 | 1 | 0.69087 | 0.84475 | 0.857645 | 0.677438 | 1.32745 |
| bad | bad_dense_right_island | 782 | 215 | 1 | 14.313 | 0.991687 | 1 | 14.2891 | 20.8389 |
| bad | bad_detector_template_disagree | 436 | 215 | 1 | 12.957 | 1.29985 | 1 | 12.9455 | 19.0498 |
| bad | bad_highfreq_detail_noise | 55 | 214 | 1 | 25.964 | 1.5659 | 1 | 25.9752 | 38.0273 |
| bad | bad_low_qrs_visibility | 38 | 214 | 1 | 5.17023 | 1.5381 | 0.955882 | 5.00522 | 12.8277 |
| bad | bad_other_boundary | 340 | 214 | 1 | 12.8991 | 1.56959 | 1 | 12.8619 | 17.7014 |
| good | good_clean_core | 2537 | 300 | 1 | 1.61232 | 1.18336 | 0.987886 | 1.55635 | 2.24919 |
| good | good_hard_baseline_lowqrs | 2830 | 300 | 1 | 0.90408 | 0.947005 | 0.675945 | 0.893523 | 1.25465 |
| good | good_isolated_low_purity | 791 | 300 | 1 | 0.951766 | 1.15402 | 0.945204 | 0.978544 | 2.02866 |
| good | good_mild_artifact_outlier | 802 | 300 | 1 | 1.13418 | 0.999562 | 0.922079 | 1.13458 | 1.55095 |
| good | good_overlap_boundary | 5074 | 300 | 1 | 0.988002 | 1.15592 | 0.86761 | 0.955277 | 1.73388 |
| medium | medium_clean_core | 708 | 250 | 1 | 0.61903 | 0.944814 | 0.703937 | 0.639713 | 1.30993 |
| medium | medium_hard_baseline_lowqrs | 1920 | 250 | 1 | 0.593618 | 0.925734 | 0.549666 | 0.693567 | 1.36916 |
| medium | medium_outlier_or_bad_boundary | 1081 | 250 | 1 | 0.899932 | 1.05042 | 0.886974 | 0.861155 | 1.69855 |
| medium | medium_overlap_boundary | 1552 | 250 | 1 | 0.548128 | 0.747308 | 0.763619 | 0.580574 | 0.932532 |
| medium | medium_visible_qrs_detail | 2109 | 250 | 1 | 0.941991 | 0.998847 | 0.936652 | 0.917763 | 1.52163 |
