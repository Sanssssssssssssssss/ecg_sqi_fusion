# Original Bad-Stress Failure: sqiquery_auxprimitive_boundary

Post-hoc report-only analysis. Original BUT is not used for training or model selection.

- test bad outlier stress: n=292, raw recall=0.0068, badcal recall=0.0719
- test bad core/near-boundary: n=119, raw recall=0.9748, badcal recall=1.0000
...
![waveform examples](E:\GPTProject2\ecg\outputs\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\original_bad_stress_failure\sqiquery_auxprimitive_boundary\original_bad_stress_waveform_examples.png)
