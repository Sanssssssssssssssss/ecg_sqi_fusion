# Original Bad-Stress Failure: sqiquery_qrsdetector_auxmask_balanced

Post-hoc report-only analysis. Original BUT is not used for training or model selection.

- test bad outlier stress: n=292, raw recall=0.0411, badcal recall=0.2500
- test bad core/near-boundary: n=119, raw recall=0.8824, badcal recall=1.0000
...
![waveform examples](E:\GPTProject2\ecg\outputs\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\good_medium_geometry_repair\original_bad_stress_failure\sqiquery_qrsdetector_auxmask_balanced\original_bad_stress_waveform_examples.png)
