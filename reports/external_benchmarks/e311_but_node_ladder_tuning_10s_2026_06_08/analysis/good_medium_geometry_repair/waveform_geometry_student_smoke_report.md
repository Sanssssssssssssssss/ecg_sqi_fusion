...
M outputs/external_benchmarks/e311_but_node_ladder_tuning_10s_2026_06_08/analysis/good_medium_geometry_repair/run_waveform_geometry_student.py
 ...
 M src/sqi_pipeline/cli.py
 M src/sqi_pipeline/config.py
 M src/sqi_pipeline/features/make_record84.py
 M src/sqi_pipeline/features/sqi.py
 M src/sqi_pipeline/noise/pca.py
 M src/sqi_pipeline/qrs/run_qrs_cache.py
 M src/sqi_pipeline/runner.py
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| quality20_detrawbeat_localhead_atlaslite_a050 | smoke | synthetic_val | 0.961606 | 0.954102 | 0.997543 | 0.944129 | 0.976562 | 1 | 24 | 6 | 0.6356 | 0.6619 |
| quality20_detrawbeat_localhead_atlaslite_a050 | smoke | synthetic_test | 0.986674 | 0.984032 | 0.993724 | 0.985390 | 0.979253 | 3 | 13 | 5 | 0.6758 | 0.6143 |
| quality20_detrawbeat_localhead_atlaslite_a050_badcal | smoke | synthetic_test | 0.986674 | 0.984032 | 0.993724 | 0.985390 | 0.979253 | 3 | 13 | 5 | nan | nan |
...
- `quality20_detrawbeat_localhead_atlaslite_a050` (smoke): best_epoch=2, useful_gate=pass, original_report_ran=False, checkpoint=`E:\GPTProject2\ecg\outputs\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\runs\waveform_geometry_student\N17043_gm_probe\smoke\quality20_detrawbeat_localhead_atlaslite_a050\ckpt_best.pt`
