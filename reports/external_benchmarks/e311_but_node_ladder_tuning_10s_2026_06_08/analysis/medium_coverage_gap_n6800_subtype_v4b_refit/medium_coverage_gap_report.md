...
| --- | --- | --- | --- | --- | --- |
| sqi_iSQI | 1.0000 | -832964358.1570 | 0.0000 | 1.0000 | missing_low_tail |
| mean_abs | 0.6250 | 2.1219 | 0.0226 | 0.0000 | center_or_both_tails |
| hjorth_activity | 0.4850 | 0.7086 | 0.1590 | 0.0000 | missing_high_tail |
| std | 0.4850 | 0.8520 | 0.1590 | 0.0000 | missing_high_tail |
| band_1_5 | 0.4726 | -1.3134 | 0.0030 | 0.2750 | missing_low_tail |
| rms | 0.4718 | 0.8222 | 0.1614 | 0.0000 | missing_high_tail |
| sqi_bSQI | 0.4499 | 1.1357 | 0.0634 | 0.0353 | center_or_both_tails |
| diff_abs_p95 | 0.4315 | 0.7005 | 0.3253 | 0.0272 | missing_high_tail |
| sqi_pSQI | 0.4005 | -1.0136 | 0.0010 | 0.0088 | center_or_both_tails |
| hf_ratio | 0.3943 | 0.8213 | 0.0343 | 0.0129 | center_or_both_tails |
| ptp_p99_p01 | 0.3754 | 0.6827 | 0.2371 | 0.0000 | missing_high_tail |
| detail_instability | 0.3659 | 0.5991 | 0.2089 | 0.0274 | missing_high_tail |
| band_15_30 | 0.3556 | 0.8839 | 0.1122 | 0.0096 | center_or_both_tails |
| sample_entropy_proxy | 0.3306 | -0.7481 | 0.0007 | 0.1630 | missing_low_tail |
| qrs_width_median | 0.3236 | -0.6565 | 0.0105 | 0.0328 | center_or_both_tails |
| wavelet_e4 | 0.3002 | 0.5109 | 0.0666 | 0.0409 | missing_high_tail |
...
## Key Figures
- Consensus feature gap: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\medium_coverage_gap_n6800_subtype_v4b_refit\medium_feature_gap_consensus_top.png`
- Best-trained medium PCA uncovered: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\medium_coverage_gap_n6800_subtype_v4b_refit\best_trained_base_scan029_medium_uncovered_pca.png`
- Best-trained region concentration: `E:\GPTProject2\ecg\reports\external_benchmarks\e311_but_node_ladder_tuning_10s_2026_06_08\analysis\medium_coverage_gap_n6800_subtype_v4b_refit\best_trained_medium_region_uncovered_bar.png`