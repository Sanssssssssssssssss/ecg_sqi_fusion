...
def train_model_suite(
    ...
    for epoch in range(1, int(args.epochs) + 1):
        ...
        log_row = {
            ...
            **{f"train_{k}": v for k, v in mean_parts.items()},
    ...
    metrics = [EVT.metric_row(candidate, "clean_val", val_rep), EVT.metric_row(candidate, "clean_test", test_rep)]
    ...
    error_routes = [error_route_row(candidate, "clean_val", val_rep), error_route_row(candidate, "clean_test", test_rep)]
    ...
    return {
        ...
        "metrics": metrics,
        "record_metrics": val_rec_rows + test_rec_rows,
        "recovery": recovery,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--record-balanced-sampler", action="store_true", default=True)
