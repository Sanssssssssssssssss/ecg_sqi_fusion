...
from supplemental_sqi_experiments.ablation_generalization import run_cross_noise_generalization, run_leave_one_out
from supplemental_sqi_experiments.common import project_root, validate_integrity, load_split_frame, write_json
...
from supplemental_sqi_experiments.mmd_paired_resampling import run_mmd_paired_resampling
...
from supplemental_sqi_experiments.strict_table6 import run_strict_table6
...
def default_paths(args: argparse.Namespace) -> dict[str, Path]:
    ...
    report_root = root / "reports" / "sqi_supplemental"
    return {
...
def run_existing_diagnostics(args: argparse.Namespace) -> dict[str, Any]:
    ...
    outputs.extend(
        run_final_claims(
            ...
            shared_images_dir=project_root() / "reports" / "sqi_paper_aligned" / "images",
            seed=args.seed,
            C=args.C,
            gamma=args.gamma,
            n_perm=args.n_perm,
