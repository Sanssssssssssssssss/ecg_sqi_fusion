...
def _load_model_hyperparams(model_dir: Path) -> dict[str, Any]:
    ...
    if ckpt_path.exists():
        ...
        return {
            ...
            "local_mask_head": hp.get("USE_LOCAL_MASK_HEAD"),
            "noise_type_head": hp.get("USE_NOISE_TYPE_HEAD"),
            "teacher_distill": hp.get("USE_TEACHER_DISTILL"),
            "sqi_head": hp.get("USE_SQI_HEAD"),
            "e_cls": hp.get("E_CLS"),
            ...
            "lambda_local_mask": hp.get("LAMBDA_LOCAL_MASK"),
            "lambda_noise_type": hp.get("LAMBDA_NOISE_TYPE"),
            "lambda_teacher": hp.get("LAMBDA_TEACHER"),
            "lambda_sqi": hp.get("LAMBDA_SQI"),
            "lambda_rank": hp.get("LAMBDA_RANK"),
            "rank_margin": hp.get("RANK_MARGIN"),
            "teacher_temperature": hp.get("TEACHER_TEMPERATURE"),
            "teacher_targets": hp.get("TEACHER_TARGETS"),
        }
    return {}
