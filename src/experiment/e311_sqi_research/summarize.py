...
def render(rows: list[dict[str, Any]]) -> str:
    ...
    lines.append("")
    lines.append("Submitted on 2026-05-28:")
    lines.append("")
    lines.append("| job id | group | array | purpose |")
    lines.append("|---:|---|---|---|")
    lines.append("| `29750889` | `head_reimpl` | `0` | baseline clone sanity run |")
    lines.append("| `29751043` | `head_reimpl` | `1-4%1` | interpretable SQI head, local quality v2, combo head, multiscale |")
    lines.append("| `29751044` | `loss_conflict` | `0-4%1` | CE-only and multi-task weighting conflict screen |")
    lines.append("| `29751045` | `target_gate_reimpl` | `0-5%1` | clean-RR targets, bad fallback target, denoise gates |")
    lines.append("| `29751046` | `generalization_loss` | `0-6%1` | label smoothing, focal, ordinal, R-Drop, SAM |")
    lines.append("")
