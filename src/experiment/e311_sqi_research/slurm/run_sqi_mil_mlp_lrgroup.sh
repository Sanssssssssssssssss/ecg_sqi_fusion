#!/bin/bash
# Isolated E3.11 SQI research: grouped-LR tuning for MIL SQI + MLP head.
#SBATCH -J e311r3_sqimil
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 grouped-LR MIL SQI MLP tuning.")
PY

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_mil_mlp_lrgroup \
