#!/bin/bash
# Isolated E3.11 SQI research: zero-init SQI residual correction on pretrained CLS logits.
#SBATCH -J e311r2_sqires
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 SQI residual tuning.")
PY2

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_residual_tuning \
