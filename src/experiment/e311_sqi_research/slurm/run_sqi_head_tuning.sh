#!/bin/bash
# Isolated E3.11 SQI research: focused SQI-injected classification head tuning.
#SBATCH -J e311r2_sqihead
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 SQI-head tuning.")
PY

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_head_tuning \
