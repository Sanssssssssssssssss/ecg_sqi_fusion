#!/bin/bash
# Isolated E3.11 SQI research: SQI-injected head with a tiny classifier MLP.
#SBATCH -J e311r2_sqimlp
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 SQI-head MLP tuning.")
PY2

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_head_mlp_tuning \
