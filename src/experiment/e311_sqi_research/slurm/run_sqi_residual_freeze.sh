#!/bin/bash
# Isolated E3.11 SQI research: freeze warm-started model, train SQI residual/head only.
#SBATCH -J e311r5_sqifrz
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 frozen SQI residual tuning.")
PY

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_residual_freeze \
