#!/bin/bash
# Isolated E3.11 SQI research: refined tuning around the best MIL SQI + MLP head.
#SBATCH -J e311r2_sqimil
...
if not torch.cuda.is_available():
    raise SystemExit("CUDA is required for E3.11 MIL SQI MLP refined tuning.")
PY

python -u -m src.experiment.e311_sqi_research.train \
  --group sqi_mil_mlp_refined \
