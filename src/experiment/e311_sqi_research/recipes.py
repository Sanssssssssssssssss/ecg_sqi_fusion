...
RECIPES: dict[str, list[dict[str, Any]]] = {
    ...
    "sqi_mil_mlp_lrgroup": [
        recipe("mil_l025_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=3.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", description="best MIL SQI MLP with slower backbone and 3x new-head LR"),
        recipe("mil_l025_lr2e5_head5", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=2.0e-5, head_lr_mult=5.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", description="more stable backbone with 5x new-head LR"),
        recipe("mil_l025_lr4e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=4.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", description="moderate backbone LR with 3x new-head LR"),
        recipe("mil_l035_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=3.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.35, level_target_mode="clean_rr", description="higher clean-RR level weight plus grouped LR"),
        recipe("mil_nodense_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=3.0e-5, head_lr_mult=3.0, description="MIL SQI MLP without dense loss plus grouped LR"),
        recipe("mil_l025_mw110_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=3.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", class_weight_medium=1.10, description="grouped LR with very mild medium weight"),
        recipe("mil_l025_ls005_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=64, lr=3.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", label_smoothing=0.005, description="grouped LR with light label smoothing"),
        recipe("mil_l025_h96_lr3e5_head3", "sqi_mil_mlp_lrgroup", head_type="sqi_mil_detach", cls_hidden=96, lr=3.0e-5, head_lr_mult=3.0, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", description="slightly wider MLP with grouped LR"),
    ],
    "sqi_residual_tuning": [
    ...
    "sqi_residual_refined": [
        recipe("resid_mil_scale025_nodense", "sqi_residual_refined", head_type="sqi_resid_mil_detach", lr=3.0e-5, head_lr_mult=5.0, sqi_delta_scale=0.25, description="conservative zero-init MIL SQI residual correction"),
        recipe("resid_mil_scale050_nodense", "sqi_residual_refined", head_type="sqi_resid_mil_detach", lr=3.0e-5, head_lr_mult=5.0, sqi_delta_scale=0.50, description="moderate zero-init MIL SQI residual correction"),
        recipe("resid_mil_scale100_nodense", "sqi_residual_refined", head_type="sqi_resid_mil_detach", lr=3.0e-5, head_lr_mult=5.0, sqi_delta_scale=1.00, description="full-scale zero-init MIL SQI residual correction"),
        recipe("resid_mil_cleanrr_l025_scale050", "sqi_residual_refined", head_type="sqi_resid_mil_detach", lr=3.0e-5, head_lr_mult=5.0, sqi_delta_scale=0.50, denoise_weight=10.0, level_weight=0.25, level_target_mode="clean_rr", description="MIL SQI residual with clean-RR level supervision"),
        recipe("resid_mil_den5_scale050", "sqi_residual_refined", head_type="sqi_resid_mil_detach", lr=3.0e-5, head_lr_mult=5.0, sqi_delta_scale=0.50, denoise_weight=5.0, description="MIL SQI residual with light denoise only"),
