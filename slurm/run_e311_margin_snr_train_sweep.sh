...
case "${SLURM_ARRAY_TASK_ID}" in
  0)
    ...
    RUN_TAG="m1_d1warm_snr005"
    EXTRA_ARGS=(--epochs 24 --lr 3e-5 --lr_eta_min 2e-6 --weight_decay 0.03 --dropout 0.10 --snr_head --lambda_snr 0.05)
    ;;
  1)
  ...
  6)
    VARIANT="e311b_snr_gap_e310_morph"
    RUN_TAG="m2_d1warm_snr005_denoise"
    EXTRA_ARGS=(--epochs 24 --lr 3e-5 --lr_eta_min 2e-6 --weight_decay 0.03 --dropout 0.10 --snr_head --lambda_snr 0.05 --e_cls 6 --e_denoise 12 --e_level 6 --lambda_den 40 --bad_den_w_max 0.35 --bad_den_w_warmup_epochs 12)
    ;;
  7)
    VARIANT="e311d_snr_primary_good_guard"
    RUN_TAG="m2_d1warm_snr005_denoise"
