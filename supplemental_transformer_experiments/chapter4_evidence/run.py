...
from . import audit, but_models, figures, repair, report, seta_build, seta_models, seta_sqi
...
def parse_args() -> argparse.Namespace:
    ...
    for name in ["audit", "seta-build", "seta-sqi", "seta-repair", "seta-models", "but-models", "figures", "report", "pipeline"]:
